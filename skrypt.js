...
function textInput(i){
    var t= '🍺 macbookair@SzymonSzymanski <b class="arrow">»</b><input type="text" name="command" id="command'+i+'" placeholder="Type command">';
    return t;
}
...
function oMnie(){
    ...
    var msgOMnie = "<br>Nazywam się Szymon Szymanski. Mam 17 lat. <br>" +
    "Jestem absolwentem drugiego roku klasy programistycznej w Technikum TEB Edukacja we Wrocławiu przy ulicy Fabryczniej 13 <br> <br>"
...
function edu()
{
    ...
    var msgedu = "<br><b> Szkola </b> <br> -Jestem uczniem Technikum TEB Eduakcja. Na zajęciach uczę się m.in. tworzenia stron interetowych, tworzenia aplikacji webowych, języka Java oraz Python <br><br> <b> Kursy </b> <br> -W trzeciej klasie technikum byłem uczystnikiem KKZ (Kurs Kształcenia Zawodowego) z zakresu INF.02 (Technik informatyk) <br><br>"
...
function dos_zawodowe()
{
    ...
    var msgdos = "<br><b> Praca </b> <br> Grinn - Tester <br> <br> <b> Projekty </b> <br> LINK -> <a class='link' href='https://github.com/Szymon191'>https://github.com/Szymon191</a> <br> <br>"
...
function command(){
    ...
    if(element.value == "help"){
        ...
        "<br>  edu" + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+ "wyswietl sciezke mojej edukacji"+
        ...
        "<br>  all" + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+ " wyswietl wszystko <br><br>"+textInput(i)
    ...
    }else if(element.value == "mentor"){
        i++

        var t= '🍺 macbookair@SzymonSzymanski <b class="arrow">»</b>'+
        '<input type="text" name="command" id="command'+i+'" placeholder="Type command">'

        document.getElementById("bg").style.backgroundImage='url(tla/tlo8.jpg)'
        var msgskills = "<br><b> Adam Karczewski 🤴 <br> <br>" + t + "<br>"
        d=document.createElement('div');
        cos = document.getElementById("message")
        cos.appendChild(d)
        d.innerHTML = msgskills; 
    ...
    async function forAll(title , funName){
        ...
        cos.appendChild(d)
        d.style.color = 'white'
        d.innerHTML = "<span id=command"+i+" style='color: rgb(33, 189, 100);'>🍺 macbookair@SzymonSzymanski <b class=arrow>»</b> </span>"
